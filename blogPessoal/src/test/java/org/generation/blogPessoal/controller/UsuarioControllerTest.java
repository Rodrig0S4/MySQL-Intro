...
public void start() {
	...
	usuario = new Usuario(0L, "João da Silva","joão@email.com.br","12345678"); 
	...
	usuario = new Usuario(2L, "Jean Marcos", "jm@email.com.br", "12345678");
...
@Test
@DisplayName("🧩🧩 Alterar Usuarios!")
@Order(3)
public void deveRealizarPutAllUsuario() {
